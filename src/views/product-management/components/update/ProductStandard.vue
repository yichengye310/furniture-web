          ...
          <el-form-item label="产品规格" :required="true">
            ...
            <el-row >
              ...
              <el-row :gutter="10" v-if="standardList!=null&&standardList.length>0" v-for="(item,index) in standardList" style="margin-bottom: 10px">
                ...
                <el-col :span="11">
                  <el-row :gutter="10" v-if="item.productStandardsColours!=null&&item.productStandardsColours.length>0" v-for="(productStandardsColour,productStandardsColourIndex) in item.productStandardsColours">
                    <el-col :span="3" >
      ...
      onSubmit() {
        ...
        this.standardList.forEach(item =>{
          let productStandardsDTO={
            bandPrice: item.bandPrice!=null&&item.bandPrice!=0?item.bandPrice*100:item.bandPrice,
            productStandardsColours: [],
            standard: item.standard,
            state: item.state,
            tradePrice: item.tradePrice!=null&&item.tradePrice!=0?item.tradePrice*100:item.tradePrice
          }
          item.productStandardsColours.forEach(productStandardsColour =>{
